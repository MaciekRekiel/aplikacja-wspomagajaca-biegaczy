...
const validateResetCode = (dispatch) => {
  return async ({
    ...
    // If there is no errors, try to make request
      ...
      try {
        const response = await serverInstance.post(`/users/reset-password/${resetCode}`, {
          email
        });
...
export const { Provider, Context } = createDataContext(
  authReducer,
  { signup, signin, forgotPassword, resendResetCode, validateResetCode, resetPassword, signout, clearErrors, autoLogin },
